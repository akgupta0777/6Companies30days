/*
Explanation:
We can use union find technique to union all the neighbouring cells and union find also maintain sizes 
of each union and we return the maximum size union as result.
*/
